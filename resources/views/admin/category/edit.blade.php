                ...
                <div class="p-6">
                    <div class="d-flex">
                        <form action="{{ route('category.update', $category['id']) }}" method="POST">
                            ...
                            <input type="text" name="name" id="name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ $category['name'] }}">
                            @error('name')
