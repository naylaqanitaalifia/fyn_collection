<x-app-layout>
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
        <div class="flex justify-end mb-4 px-6">
            <a href="{{ route('category.create') }}" class="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out">
                Add New Category
            </a>
        </div>
                        ...
                        @else
                            ...
                            @foreach ($categories as $index => $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="text-sm leading-5 text-gray-900">{{ $item['name'] }}
                                    </td>

                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="flex">
                                            <a x-data="{ tooltip: 'Edit' }" href="{{ route('category.edit', $item['id']) }}">
                                                ...
                                                <div x-show="open" class="fixed inset-0 flex items-center justify-center z-50" style="display: none;" @click.away="open = false">
                                                    <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
                                                        ...
                                                        <div class="flex justify-end">
                                                            ...
                                                            <form action="{{ route('category.delete', $item['id']) }}" method="POST" class="inline">
                                                                @csrf
                                                                @method('DELETE')
