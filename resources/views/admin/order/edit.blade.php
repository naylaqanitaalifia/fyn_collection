                ...
                <div class="p-6">
                    <div class="d-flex">
                        <form action="{{ route('order.update', $order['id']) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $order->title) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('title')
                                <small class="text-red-600">{{ $message }}</small>
                            @enderror
